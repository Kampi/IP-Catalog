proc create_ipi_design { offsetfile design_name } {
	...
	set offset_file "${bd_path}/AXI_VGA_v1_0_tb_include.vh"
	set fp [open $offset_file "w"]
	puts $fp "`ifndef AXI_VGA_v1_0_tb_include_vh_"
	puts $fp "`define AXI_VGA_v1_0_tb_include_vh_\n"
...
for { set i 1 } { 1 } { incr i } {
	set design_name "AXI_VGA_v1_0_bfm_${i}"
...
remove_files -quiet -fileset sim_1 AXI_VGA_v1_0_tb_include.vh
import_files -fileset sim_1 -norecurse -force $interface_address_vh_file
set_property top AXI_VGA_v1_0_tb [get_filesets sim_1]
